      ...
      <div class="sidebar-mini layout-fixed layout-navbar-fixed">
        <div class="wrapper">
          <div class="preloader flex-column justify-content-center align-items-center" ref="preloader">
            <img class="animation__shake" style="width: 60px;height: 60px" src="@/assets/images/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
          </div>
          <!-- Navbar -->
...
onMounted(() => {
  useHead({
    title: 'My AdminLte',
    meta: [
      { name: 'description', content: 'Админка.' }
    ],
    link: [
