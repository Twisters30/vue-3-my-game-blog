...
<!--        <img class="animation__wobble" src="@/assets/images/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">-->
<!--      </div>-->
      ...
      <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <!-- Right navbar links -->
        <ul class="navbar-nav ml-auto" ref="list">
          <!-- Navbar Search -->
          <li class="nav-item">
...
onBeforeMount(() => {
  useHead({
    ...
    script: [
      { src: '/js/jquery/jquery.min.js', type: 'text/javascript', async:true },
      { src: '/js/bootstrap.bundle.min.js', type: 'text/javascript', defer:true, body: true},
      { src: '/js/adminlte.min.js' , type: 'text/javascript', defer:true ,body: true},
    ]
  });
})
</script>
