                  ...
                  <div class="col-md-8">
                    ...
                    <div class="chart">
                      ...
                      <canvas
                        id="salesChart"
                        height="180"
                        style="height: 180px; display: block; width: 1050px"
                        width="1050"
              ...
              <div class="col-md-6">
                ...
                <div class="card direct-chat direct-chat-warning">
                  <div class="card-header">
                    ...
                    <div class="card-tools">
                      <span title="3 New Messages" class="badge badge-warning"
                        >3</span
                      >
                      <button
                        type="button"
                      ...
                      <ul class="contacts-list">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="@/assets/images/user7-128x128.jpg"
                              alt="User Avatar"
                            />
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="@/assets/images/user8-128x128.jpg"
                              alt="User Avatar"
                            />
                  ...
                  <div class="col-md-8">
                    <div class="chart-responsive">
                      ...
                      <canvas
                        ...
                        height="161"
                        width="322"
                        style="display: block; width: 322px; height: 161px"
                        class="chartjs-render-monitor"
                      ></canvas>
                    </div>
                    <!-- ./chart-responsive -->
                ...
                <ul class="products-list product-list-in-card pl-2 pr-2">
                  <li class="item">
                    <div class="product-img">
                      <img
                        src="@/assets/images/default-150x150.png"
                        alt="Product Image"
                        class="img-size-50"
                      />
                    </div>
