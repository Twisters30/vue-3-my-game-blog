  ...
  return (() => {
    ...
    return (
      (() => {
        ...
        function r(t) {
          return -1 === e().inArray(t.toLowerCase(), n)
            ? "'".concat(t, "'")
            : t;
        }
        var a,
            ...
            return t.length
              ? b(t).reduce(
                  function (t, n) {
                    var o = g(t);
                    return (
                      e(g(o), n) ? (o[o.length] = n) : (t[t.length] = [n]), t
                    );
                  },
                  [[v(t)]]
                )
        ...
        function E(t) {
          return (
            !C(t) && t && /^DIV|^P|^LI|^H[1-7]/.test(t.nodeName.toUpperCase())
          );
        }
        var I = x("PRE"),
          $ = x("LI");
        ...
        function nt(t, e) {
          ...
          if (O(t.node) === t.offset) {
            ...
            i
              ? ((n = i), (o = 0))
              : ((n = t.node.parentNode), (o = J(t.node) + 1));
          } else
            tt(t.node)
        ...
        function ot(t, e) {
          ...
          if (O(t.node) === t.offset) {
            ...
            if (((o = 0), U((n = t.node.childNodes[t.offset]))))
              return U(t.node.nextSibling)
                ? null
                : { node: t.node.nextSibling, offset: o };
          } else if (((n = t.node), (o = e ? O(t.node) : t.offset + 1), U(n)))
            return null;
          return { node: n, offset: o };
        }
        function it(t) {
        ...
        function at(t, e) {
          ...
          return (
            _(a, V(r)),
            n || (j(t.node), j(a)),
            i && (U(t.node) && ct(t.node), U(a))
              ? (ct(a), t.node.nextSibling)
              : a
          );
        }
        function st(t, e, n) {
        ...
        const ht = {
          ...
          splitPoint: function (t, e) {
            ...
            var s =
              n &&
              st(n, t, { isSkipPaddingBlankHTML: e, isNotSplitEdgePoint: e });
            return (
            ...
            (o = [
              ...
              },
              {
                ...
                value: function (t) {
                  var e = this.modules[t];
                  e.shouldInitialize() &&
                    (e.events && ht.detachEvents(this.$note, e.events),
                    e.destroy && e.destroy()),
              ...
              },
              {
                ...
                value: function (t, n) {
                  ...
                  return function (i) {
                    ...
                    o.invoke(
                      t,
                      n || r.closest("[data-value]").data("value"),
                      r
                    );
                  };
                },
        ...
        e().fn.extend({
          summernote: function () {
            ...
            (i.langInfo = e().extend(
              ...
              (i.tooltip =
                "auto" === i.tooltip ? !f.isSupportTouch : i.tooltip),
            ...
            (o = [
              {
                ...
                value: function () {
                  ...
                  return (
                    e.setEndPoint(
                      "EndToEnd",
                      gt({ node: this.ec, offset: this.eo })
                    ),
                    e
                  );
                },
                  ...
                  var e = function (t, e) {
                      ...
                      if (
                        ...
                        (!ht.isEdgePoint(t) ||
                          ...
                          (ht.isRightEdgePoint(t) &&
                            e &&
                            ht.isVoid(t.node.nextSibling)) ||
                          (ht.isLeftEdgePoint(t) &&
                            !e &&
                            ht.isVoid(t.node.previousSibling)) ||
                      ...
                      if (!o) {
                        ...
                        o =
                          (ht.isLeftEdgePointOf(t, n) || ht.isVoid(i.node)) &&
                          !e;
                      }
                      var r = !1;
                      if (!r) {
                        ...
                        r =
                          (ht.isRightEdgePointOf(t, n) || ht.isVoid(a.node)) &&
                          e;
                      }
                      if (o || r) {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (e) {
                    ...
                    if (
                      (i = i.concat(
                        ht.listNext(e.nextSibling, ht.isParaInline)
                      )).length
                    ) {
        ...
        const yt = {
            ...
            if (!i && 1 === arguments.length) {
              ...
              return (
                ...
                this.createFromBodyElement(
                  r,
                  ht.emptyPara === arguments[0].innerHTML
                )
              );
            }
            return i;
          ...
          createFromNode: function (t) {
            ...
            return (
              ht.isVoid(e) &&
                ((n = ht.listPrev(e).length - 1), (e = e.parentNode)),
              ht.isBR(o)
                ? ((i = ht.listPrev(o).length - 1), (o = o.parentNode))
                : ht.isVoid(o) &&
                  ((i = ht.listPrev(o).length), (o = o.parentNode)),
              this.create(e, n, o, i)
            );
          },
        ...
        const wt = {
          isEdit: function (t) {
            return k.contains(
              [kt.BACKSPACE, kt.TAB, kt.ENTER, kt.SPACE, kt.DELETE],
              t
            );
          },
          isMove: function (t) {
              ...
              },
              {
                ...
                value: function (t) {
                  null !== t.contents && this.$editable.html(t.contents),
                    null !== t.bookmark &&
                      yt.createFromBookmark(this.editable, t.bookmark).select();
                },
              },
              {
                key: "rewind",
          ...
          return (
            ...
            (o = [
              ...
              },
              {
                ...
                value: function (t, n) {
                  e().each(
                    t.nodes(ht.isPara, { includeAncestor: !0 }),
                    function (t, o) {
                      e()(o).css(n);
                    }
                  );
              ...
              },
              {
                ...
                value: function (t, n) {
                  ...
                  var a = ht.makePredByNodeName(o),
                    s = t
                      .nodes(ht.isText, { fullyContains: !0 })
                      .map(function (t) {
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  return (
                    (o.anchor =
                      t.isOnAnchor() && ht.ancestor(t.sc, ht.isAnchor)),
              ...
              },
              {
                ...
                value: function (t, n) {
                  ...
                  if (k.find(r, ht.isPurePara)) {
                    ...
                    var c = i
                      .nodes(ht.isList, { includeAncestor: !0 })
                      .filter(function (n) {
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  return (
                    ...
                    r &&
                      (ht.appendChildNodes(a, k.from(r.childNodes)),
                      ht.remove(r)),
                    t
                  );
                },
            ...
            (o = [
              ...
              },
              {
                ...
                value: function (t, n) {
                  n = (n = (n =
                    n ||
                    yt.create(t)).deleteContents()).wrapBodyInlineWithPara();
                  var o,
                    i = ht.ancestor(n.sc, ht.isPara);
                  if (i) {
                    if (
                      ht.isLi(i) &&
                      (ht.isEmpty(i) || ht.deepestChildIsEmpty(i))
                    )
                ...
                value: function (t, n) {
                  ...
                  if ("top" === n) i.before(a);
                    ...
                    if (o.rowSpan > 1) {
                      ...
                      return void e()(e()(i).parent().find("tr")[f]).after(
                        e()(a)
                      );
                    }
                    i.after(a);
          ...
          function t(n) {
            ...
            (this.insertParagraph = this.wrapCommand(function () {
              ...
              (this.insertHorizontalRule = this.wrapCommand(function () {
                ...
                t.nextSibling &&
                  o.setLastRange(
                    yt.create(t.nextSibling, 0).normalize().select()
                  );
              })),
              ...
              (this.createLink = this.wrapCommand(function (t) {
                ...
                if (!(l > 0 && o.isLimited(l))) {
                  ...
                  e().each(u, function (t, o) {
                    e()(o).attr("href", n),
                      r
                        ? e()(o).attr("target", "_blank")
                        : e()(o).removeAttr("target");
                  }),
            ...
            (o = [
                  ...
                  return (
                    ...
                    (void 0 === e ||
                      !(
                        ...
                        e.metaKey ||
                        k.contains(
                          [wt.code.BACKSPACE, wt.code.DELETE],
                          e.keyCode
                        )
                      )) &&
                ...
                value: function (t) {
                  t
                    ...
                    : ((this.lastRange = yt.create(this.editable)),
                      0 ===
                        e()(this.lastRange.sc).closest(".note-editable")
                          .length &&
                        (this.lastRange = yt.createFromBodyElement(
                          this.editable
                        )));
                },
              },
                      ...
                      i.beforeCommand(),
                        "function" == typeof n
                          ...
                          : ("string" == typeof n && t.attr("data-filename", n),
                            t.css(
                              "width",
                              Math.min(i.$editable.width(), t.width())
                            )),
                        t.show(),
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  e().each(t, function (t, o) {
                    ...
                    n.options.maximumImageFileSize < o.size
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    t.isOnAnchor() &&
                      (t = yt.createFromNode(ht.ancestor(t.sc, ht.isAnchor))),
                    t.toString()
                  );
                },
              },
              {
                ...
                value: function (t, n) {
                  if (
                    ...
                    n &&
                      n.length &&
                      (n[0].tagName.toUpperCase() !== t.toUpperCase() &&
                        (n = n.find(t)),
                      n && n.length))
                  ) {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    n.length && (o.isNewWindow = "_blank" === n.attr("target")),
                    o
                  );
                },
              },
              ...
              },
              {
                ...
                value: function () {
                  return (
                    ht.isEmpty(this.$editable[0]) ||
                    ht.emptyPara === this.$editable.html()
                  );
                },
              },
              {
            ...
            (n = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    (this.$codable.val(
                      ht.html(this.$editable, this.options.prettifyHtml)
                    ),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var e = this.purify(
                      ht.value(this.$codable, this.options.prettifyHtml) ||
                        ht.emptyPara
                    ),
                          ...
                          i = function (e) {
                            ...
                            (i =
                              t.options.minheight > 0
                                ? Math.max(i, t.options.minheight)
                                : i),
                              (i =
                                t.options.maxHeight > 0
                                  ? Math.min(i, t.options.maxHeight)
                                  : i),
                              (r =
                                t.options.minheight > 0
            ...
            return (
              ...
              (o = [
                ...
                },
                {
                  key: "handleKeyup",
                  value: function (t) {
                    k.contains([wt.code.ENTER, wt.code.SPACE], t.keyCode) &&
                      this.replace();
                  },
                },
              ]) && Yt(n.prototype, o),
              ...
              },
              {
                ...
                value: function (t) {
                  if (
                    ...
                    k.contains(this.keys, this.previousKeydownCode)
                  )
                  ...
                  return (
                    Object.prototype.hasOwnProperty.call(
                      ...
                      (this.fontInstalledMap[t] =
                        f.isFontInstalled(t) ||
                        k.contains(this.options.fontNamesIgnoreCheck, t)),
                    this.fontInstalledMap[t]
                  );
                },
              },
                          ...
                          ],
                          {
                            callback: function (e) {
                              e.find(".note-dimension-picker-mousecatcher")
                                .css({
                                  width:
                                    t.options.insertTableMaxSize.col + "em",
                                  height:
                                    t.options.insertTableMaxSize.row + "em",
                                })
                                .mouseup(
                                  t.context.createInvokeHandler(
                                    "editor.insertTable"
                    ...
                    this.context.memo("button.link", function () {
                      return t
                        .button({
                          ...
                          click:
                            t.context.createInvokeHandler("linkDialog.show"),
                        })
                        .render();
                    }),
                    ...
                    this.context.memo("button.codeview", function () {
                      return t
                        .button({
                          ...
                          click:
                            t.context.createInvokeHandler("codeview.toggle"),
                        })
                        .render();
                    }),
                    ...
                    this.context.memo("button.help", function () {
                      return t
                        .button({
                          ...
                          click:
                            t.context.createInvokeHandler("helpDialog.show"),
                        })
                        .render();
                    });
                },
                ...
                value: function (t, e) {
                  for (var n = 0, o = e.length; n < o; n++) {
                    for (
                      ...
                      u &&
                        s.append("function" == typeof u ? u(this.context) : u);
                    }
                    s.appendTo(t);
                  }
                },
                  ...
                  this.$popover = this.ui
                    .popover({
                      ...
                      callback: function (t) {
                        ...
                        ).prepend('<span><a target="_blank"></a>&nbsp;</span>');
                      },
                    })
                    .render()
            ...
            (o = [
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  var n =
                    ht.isCell(t) ||
                    ht.isCell(null == t ? void 0 : t.parentElement);
                  if (n) {
                ...
                value: function (t) {
                  ...
                  if (o && 11 === o[1].length) {
                    ...
                    if (void 0 !== o[2]) {
                      ...
                      if (y)
                        for (
                          var k = [3600, 60, 1], w = 0, C = k.length;
                          w < C;
                          w++
                        )
                          b +=
                            void 0 !== y[w + 1]
                              ? k[w] * parseInt(y[w + 1], 10)
                              : 0;
                    }
                    n = e()("<iframe>")
                      .attr("frameborder", 0)
                    ...
                    n = e()("<iframe>")
                      ...
                      .attr(
                        "src",
                        "https://drive.google.com/file/d/" + i[1] + "/preview"
                      )
                      .attr("width", "640")
                      .attr("height", "480");
                    ...
                    n = e()("<iframe>")
                      ...
                      .attr(
                        "src",
                        "https://instagram.com/p/" + r[1] + "/embed/"
                      )
                      .attr("width", "612")
                      .attr("height", "710")
                      .attr("scrolling", "no")
            ...
            (o = [
              {
                ...
                value: function () {
                  return (
                    this.options.airMode && !k.isEmpty(this.options.popover.air)
                  );
                },
              },
              {
            ...
            (o = [
                ...
                value: function (t, n) {
                  ...
                  return (
                    this.searchKeyword(t, n, function (e) {
                      (e = e || []).length &&
                        (i.html(o.createItemTemplates(t, e)), o.show());
                    }),
                    i
                  );
                },
              },
              {
                ...
                value: function (t) {
                  ...
                  if (
                    !k.contains(
                      [wt.code.ENTER, wt.code.UP, wt.code.DOWN],
                      t.keyCode
                    )
                  ) {
                    var o,
                    ...
                    if ("words" === this.options.hintMode) {
                      if (
                        ...
                        this.hints.forEach(function (t) {
                          if (t.match.test(i))
                            return (o = r.getWordsMatchRange(t.match)), !1;
                        }),
                        !o)
                      )
                    ...
                    if (this.hints.length && i) {
                      ...
                      a &&
                        ...
                        this.hints.forEach(function (t, e) {
                          t.match.test(i) &&
                            n.createGroup(e, i).appendTo(n.$content);
                        }),
                        this.$content
